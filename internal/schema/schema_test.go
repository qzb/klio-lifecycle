...
func Test_migrate_service_with_all_properties_from_v1beta4(t *testing.T) {
	input := dedent.Dedent(`
...
func TestToInternal(t *testing.T) {
	...
	for i, c := range cases {
		...
		t.Run(c.name, func(t *testing.T) {
			...
			// e, _ := yaml.Marshal(c.expected)
			i, _ := yaml.Marshal(c.input)
